...
class Client
{
    ...
    private function _performHttpRequest($request)
    {
        ...
        if(stristr($result,"302 Found")) throw new Exception("Cannot Connect to Server.");
    ...
    protected function _getOperator($name)
    {
        if (!isset($this->_operatorsCache[$name])) {
            ...
            if(!class_exists($className)){
                if(file_exists(__DIR__.DIRECTORY_SEPARATOR."Struct".DIRECTORY_SEPARATOR.$name.DS."Info.php"))
                    include __DIR__.DIRECTORY_SEPARATOR."Struct".DIRECTORY_SEPARATOR.$name.DS."Info.php";

                if(file_exists(__DIR__.DIRECTORY_SEPARATOR."Struct".DIRECTORY_SEPARATOR.$name.DS."GeneralInfo.php"))
                    include __DIR__.DIRECTORY_SEPARATOR."Struct".DIRECTORY_SEPARATOR.$name.DS."GeneralInfo.php";

                include __DIR__.DIRECTORY_SEPARATOR."Operator".DIRECTORY_SEPARATOR.$name.".php";
            }
